...
},{"indexof":"../node_modules/indexof/index.js"}],"C:/Users/pipey/AppData/Local/Yarn/Data/global/node_modules/parcel-bundler/src/builtins/_empty.js":[function(require,module,exports) {
...
},{"browser-split":"../node_modules/browser-split/index.js","class-list":"../node_modules/class-list/index.js","html-element":"C:/Users/pipey/AppData/Local/Yarn/Data/global/node_modules/parcel-bundler/src/builtins/_empty.js"}],"../node_modules/observable/index.js":[function(require,module,exports) {
;(function () {
"use strict";
...
function value(initialValue, reducer) {
  ...
  observable.set = function (val) {
    useHook ? all(listeners, _val = isGet(reducer) ? val : initialValue(_val, val)) : all(listeners, _val = val)
  }
  ...
  function observable(val) {
    return (
      isGet(val) ? _val
        : isSet(val) ? useHook ? all(listeners, _val = isGet(reducer) ? val : initialValue(_val, val)) : all(listeners, _val = val)
...
var DOCUMENT_ELEMENT_TYPE = 1; // DOM patching method
...
function isEqual(oldNode, newNode) {
  if (oldNode.nodeType === DOCUMENT_ELEMENT_TYPE && _hyperscript.eventStore.has(newNode)) {
    var n = _hyperscript.eventStore.get(newNode);

    var o = _hyperscript.eventStore.get(oldNode);

    if (o) {
      _hyperscript.eventStore.delete(oldNode);
    ...
    for (var _i in n) {
      oldNode.addEventListener(_i, n[_i]);
    }

    _hyperscript.eventStore.set(oldNode, n);

    _hyperscript.eventStore.delete(newNode);
  } // continue diffing if newNode has children
  ...
  return input(oldNode, newNode) || oldNode.isEqualNode(newNode);
}

function input(oldNode, newNode) {
  ...
  if (oldNode.hasAttribute('autofocus')) {
    oldNode.focus();
  }
...
function setAttributes(oldAttributes, newAttributes) {
  var i, a, b, ns, name; // Remove old attributes.
...
var _default = patcher;
exports.default = _default;
},{"hyperscript":"../node_modules/hyperscript/index.js"}],"../render.js":[function(require,module,exports) {
"use strict";
...
var render = function render(node, observable, caller) {
  if (Array.isArray(observable)) {
    (0, _observable.compute)(observable, function () {
      for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }

      return internalRender.apply(null, args);
    });
  } else {
  ...
  function internalRender() {
    ...
    var v = caller.apply(void 0, arguments);

    if (Array.isArray(v)) {
      Array.from(v, function (v) {
        return f.appendChild(isNode(v) ? v : document.createTextNode(v));
      });
    } else {
      f.appendChild(isNode(v) ? v : document.createTextNode(v));
    }

    (0, _patch.default)(node, f);
  }
...
},{"./patch":"../patch.js","observable":"../node_modules/observable/index.js"}],"app/utils.js":[function(require,module,exports) {
"use strict";
...
var todoReducer = function todoReducer(state, _ref) {
  ...
  switch (action) {
    ...
    case 'clearComplete':
      {
        var _todos2 = state.todos.filter(function (t) {
          return !t.completed;
        });
    ...
    case 'completeAll':
      {
        var _todos3 = state.todos.map(function (t) {
...
var header = function header(_ref) {
  ...
  return (0, _hyperscript.default)('header', (0, _hyperscript.default)('h1', 'todos'), (0, _hyperscript.default)('input.new-todo', {
    onkeyup: onkeyup,
...
var input = _observable.default.input;
...
var todoItem = function todoItem(item) {
  ...
  return (0, _hyperscript.default)('li', {
    ...
    onclick: destroy
  })), (0, _hyperscript.default)('input.edit', {
    value: todo,
    onkeyup: onkeyup,
    autofocus: true
  }));
...
var todoFooter = function todoFooter(_ref) {
  ...
  return (0, _hyperscript.default)('footer.footer', (0, _hyperscript.default)('span.todo-count', (0, _hyperscript.default)('strong', count), " item".concat(plural, " left")), (0, _filter.filter)({
    filter: filter,
...
exports.app = exports.dispatchFilter = exports.filter = exports.dispatch = exports.state = void 0;
...
var input = _observable.default.input; // for the sake of clarity purpose and
...
var useReducer = _observable.default; // non-scope observable declaration

var _useReducer = useReducer(_todoReducer.todoReducer, _todoReducer.initialTodo),
    _useReducer2 = _slicedToArray(_useReducer, 2),
    state = _useReducer2[0],
    dispatch = _useReducer2[1]; // non-scope observable declaration
...
state(function (state) {
  return (// if all todos is checked, toggle it
    handler && handler(state.isChecked)
  );
});

var app = function app(state, filter) {
  var todos = state.todos,
      plural = state.plural,
      count = state.count,
      isChecked = state.isChecked,
      clearToggle = state.clearToggle;
  var len = todos.length > 0;
  ...
  var useTodos = function useTodos(name) {
  ...
  var node = (0, _hyperscript.default)('section.todoapp', (0, _header.header)({
    dispatch: dispatch
  }), len ? (0, _hyperscript.default)('section.main', toggleAll, (0, _hyperscript.default)('label ', {
    attrs: {
      for: 'toggle-all'
    }
  }, 'Mark all as complete'), (0, _todo.todo)({
    todos: useTodos(name),
    dispatch: dispatch
  })) : null, len ? (0, _todoFooter.todoFooter)({
    show: todos.length,
    count: count,
    plural: plural,
...
exports.app = app;
},{"hyperscript":"../node_modules/hyperscript/index.js","observable":"../node_modules/observable/index.js","../../render":"../render.js","./reducers/todoReducer":"app/reducers/todoReducer.js","./reducers/filterReducer":"app/reducers/filterReducer.js","./header":"app/header.js","./todo":"app/todo.js","./todoFooter":"app/todoFooter.js","./utils":"app/utils.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
(0, _render.render)(document.getElementById('app'), // mount node
[_todoapp.state, _todoapp.filter], // observable(s) to listen, pass as array if more than one
_todoapp.app // the target function hook
);
},{"./app/todoapp":"app/todoapp.js","../render":"../render.js"}],"C:/Users/pipey/AppData/Local/Yarn/Data/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/pipey/AppData/Local/Yarn/Data/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
